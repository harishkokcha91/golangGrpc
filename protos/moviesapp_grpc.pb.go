...
type MovieClient interface {
	...
	CreatMovie(ctx context.Context, in *MovieInfo, opts ...grpc.CallOption) (*Id, error)
	UpdateMoview(ctx context.Context, in *MovieInfo, opts ...grpc.CallOption) (*Status, error)
...
func (c *movieClient) CreatMovie(ctx context.Context, in *MovieInfo, opts ...grpc.CallOption) (*Id, error) {
	out := new(Id)
	err := c.cc.Invoke(ctx, "/moviesapp.Movie/CreatMovie", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *movieClient) UpdateMoview(ctx context.Context, in *MovieInfo, opts ...grpc.CallOption) (*Status, error) {
	out := new(Status)
	err := c.cc.Invoke(ctx, "/moviesapp.Movie/UpdateMoview", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MovieServer interface {
	...
	CreatMovie(context.Context, *MovieInfo) (*Id, error)
	UpdateMoview(context.Context, *MovieInfo) (*Status, error)
...
func (UnimplementedMovieServer) CreatMovie(context.Context, *MovieInfo) (*Id, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreatMovie not implemented")
}
func (UnimplementedMovieServer) UpdateMoview(context.Context, *MovieInfo) (*Status, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateMoview not implemented")
}
...
func _Movie_CreatMovie_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MovieInfo)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MovieServer).CreatMovie(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/moviesapp.Movie/CreatMovie",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MovieServer).CreatMovie(ctx, req.(*MovieInfo))
	}
	return interceptor(ctx, in, info, handler)
}

func _Movie_UpdateMoview_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MovieInfo)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MovieServer).UpdateMoview(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/moviesapp.Movie/UpdateMoview",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MovieServer).UpdateMoview(ctx, req.(*MovieInfo))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Movie_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CreatMovie",
			Handler:    _Movie_CreatMovie_Handler,
		},
		{
			MethodName: "UpdateMoview",
			Handler:    _Movie_UpdateMoview_Handler,
		},
		{
